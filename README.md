...
pequeno projeto desenvolvido seguindo o livecoding da DIO, sistema para o gerenciamento de pessoas de uma empresa através de uma API REST, criado com o Spring Boot.
